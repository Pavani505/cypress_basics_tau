...
async function startEgTunnelService({
  ...
  tcpTunnelOptions = {
    ...
    preAllocation: Math.max(1, Number(process.env.APPLITOOLS_EG_TUNNEL_PRE_ALLOCATION_CONNECTIONS || 15)),
  ...
  if (!egTunnelManagerUrl){
    egTunnelManagerUrl = region === 'australia-southeast' ? 'https://exec-au.applitools.com': 'https://exec-wus.applitools.com'
  }

  if(!tcpTunnelOptions.host){
    tcpTunnelOptions.host = region === 'australia-southeast' ? 'exec-tunnel-au.applitools.com' : 'exec-tunnel-wus.applitools.com'
  }
